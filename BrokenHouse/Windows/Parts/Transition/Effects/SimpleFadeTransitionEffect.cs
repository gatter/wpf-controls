...
{
    /// <summary>
    /// Provides a fade transition effect that will simply fade-in and fade-out the transition frames.
    /// </summary>
    public class SimpleFadeTransitionEffect : TransitionEffect
    {
        private static ResourceDictionaryEffectStore EffectStore = new ResourceDictionaryEffectStore("/Windows/Parts/Transition/Effects/Resources/SimpleFade.xaml");
