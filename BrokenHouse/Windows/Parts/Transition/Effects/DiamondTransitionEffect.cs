...
{
    /// <summary>
    /// Provides the diamond mask based transition effect.
    /// </summary>
    public class DiamondTransitionEffect : TransitionEffect
    {
        private static ResourceDictionaryEffectStore EffectStore = new ResourceDictionaryEffectStore("/Windows/Parts/Transition/Effects/Resources/Diamond.xaml");
