...
{
    internal class ClassicWizardTitlePageInitializer : DefaultInitializer
    {
        /// <summary>
        /// Create the classic title page initialiser
        /// </summary>
        ...
        public override void InitializeDefaults( ModelItem page, EditingContext context )
        {
            ...
            page.Properties[Metadata.ClassicWizardTitlePageTitlePropertyId].SetValue(page.Name);
